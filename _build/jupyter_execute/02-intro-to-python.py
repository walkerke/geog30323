...
# 
# To get started, click __File > Save a copy in Drive__ to save your assignment in your personal Google Drive.  By default, the notebook will be found in a "Colab Notebooks" folder in your Drive.  Rename the notebook by clicking the name of the notebook at the top of the screen and replacing "Copy of" with your last name.  
...
# 
# __Exercise 1__: Create a new cell below with the "Add text cell" option.  Change the cell type to __Markdown__ from the drop-down menu at the top of the screen.  Practice writing some Markdown in the cell.  The cell should include a numbered list of links to your five favorite websites, with an H2 header for the title.  The links should not simply be the website URLs, but should instead show the name of the website, which you can click to get to the website.  Also, make the name of the first entry in bold, and the name of the second entry in italics.
# 
...
# To submit your assignment, click the __Share__ button and share your assignment with kwalkertcu@gmail.com.  
