...
To use these libraries in CoCalc, the __Classical Notebook__, not the default CoCalc notebook, must be used
...
* Plotly can convert existing matplotlib or seaborn plots to interactive charts
* The seaborn styling will not always carry over perfectly

```python
import plotly.offline as py
py.init_notebook_mode()

sns.scatterplot(data = mx, x = 'pri10', y = 'mus09')
