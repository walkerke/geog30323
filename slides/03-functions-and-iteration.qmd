...
* After function definitions, code should be __indented__. The Python convention is four spaces; Colab uses two by default. Either works if you're consistent, and Colab will indent for you after the colon
