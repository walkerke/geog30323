...
<img src="img/04-modules-and-eda/data.jpg" style="width: 850px"/>

<figcaption>Source: [bigdatapix.tumblr.com](http://bigdatapix.tumblr.com/)</figcaption>

------------------------------------------------------------------------

### The data analysis process

<img src="img/04-modules-and-eda/r4ds-data-science.png" style="width: 800px"/>

<figcaption>Source: Wickham and Grolemund, [*R for Data Science*](http://r4ds.had.co.nz/introduction.html)</figcaption>
...
<img src="img/04-modules-and-eda/pydata.PNG" style="width: 700px"/>

<figcaption>Source: [Jake VanderPlas, SciPy 2015 Keynote](https://speakerdeck.com/jakevdp/the-state-of-the-stack-scipy-2015-keynote)</figcaption>
...
-   Download link: <https://github.com/walkerke/geog30323/blob/main/data/colleges.csv> (click **Download raw file**)
...
-   In Colab, click the **folder icon** in the left sidebar to open the Files pane, then the **upload** button, and choose the file
-   It lands in `/content`, Colab's working directory - so `pd.read_csv("colleges.csv")` finds it
-   Uploaded files **disappear when the runtime disconnects**. Re-upload, or mount your Google Drive
:::
...
-   **Interval**: additive; the zero is arbitrary (0°F is not "no temperature")
