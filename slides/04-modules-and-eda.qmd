...
<!-- SCAFFOLDING (Kyle to re-voice, delete this comment):
     ...
     2,263 colleges before showing the histogram: symmetric? piled up at one end? two humps?
     Then reveal. The actual shape (June 2026 Scorecard release): roughly symmetric, peak near
     0.5, wide - and small spikes at BOTH ends: 39 institutions report exactly 0% and 33 report
     exactly 100%. Worth asking the room whether those are real or a data problem (tiny cohorts,
     suppressed values) - the describe() min of 0.000 and max of 1.000 already hinted at it.
     This sets up Assignment 3's "do your data appear skewed?" question as a prediction they
     already practiced. -->

- [KYLE: 2,263 colleges. Before I show you: sketch the shape you expect for graduation rates]
