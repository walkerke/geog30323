...
* Download link: <https://github.com/walkerke/geog30323/blob/main/data/grad_rates.csv> (click __Download raw file__)
...
sns.histplot(data = grad, x = "median_earn")
```
...
```python
sns.kdeplot(data = grad, x = "median_earn", fill = True)
```
...
```python
sns.boxplot(data = grad, y = "median_earn", color = "green")
```
...
```python
sns.violinplot(data = grad, x = "median_earn", color = "cyan")
```
