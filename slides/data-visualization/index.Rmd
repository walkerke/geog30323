...
sns.barplot(x = 'gdp08', y = 'name', data = mx.sort('gdp08', ascending = False), palette = "Greens_r")
```
...
* Use of exponential scale (generally, $10^{n}$) to better show trends
...
```python
plt.savefig('destfile.jpg', dpi = XXX)
```
