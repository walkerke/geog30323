...
[<img src=img/10-interactive/nyt-migration.png style="width: 900px">](http://www.nytimes.com/interactive/2014/08/13/upshot/where-people-in-each-state-were-born.html?_r=0#Texas)<figcaption>Source: _The New York Times_</figcaption>
...
<iframe width="900" height="550" src="https://labs.strava.com/heatmap/#11.55/-97.30973/32.75073/hot/all" frameborder="0"></iframe><figcaption>[Direct link to map](https://labs.strava.com/heatmap/#11.55/-97.30973/32.75073/hot/all)</figcaption>
...
* In CoCalc, interactivity only available in the __Classical Notebook__: change the format to get this code to work
...
```
<img src=img/10-interactive/basic.png>

---

### Interactivity in the Notebook

* In CoCalc: interactivity requires the __Classical__ rather than the __Modern__ notebook
