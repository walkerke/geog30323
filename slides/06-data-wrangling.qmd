...
debt_df.head()
```
<img src=img/06-data-wrangling/drop_cols.png>
...
<img src=img/06-data-wrangling/ex1.png style="width: 400px">
...
```
<img src=img/06-data-wrangling/index_name.png>
...
debt_df1.head()
```
<img src=img/06-data-wrangling/sub1.png>
...
```
<img src=img/06-data-wrangling/txdebt.png>
...
sw_debt_df.head()
```
<img src=img/06-data-wrangling/swdebt.png>
...
df2.head()
```
<img src=img/06-data-wrangling/assign.png>
...
```
<img src=img/06-data-wrangling/newcol.png>
...
sw_debt_clean.head()
```
<img src=img/06-data-wrangling/dropna.png>
...
sw_debt_fill.head()
```
<img src=img/06-data-wrangling/fillna.png>
...
```
<img src=img/06-data-wrangling/facet.png style="width:350px">
...
```
<img src=img/06-data-wrangling/merge.png>
...
```
<img src=img/06-data-wrangling/inner.png>
...
```
<img src=img/06-data-wrangling/left.png>
...
```
<img src=img/06-data-wrangling/right.png>
...
```
<img src=img/06-data-wrangling/outer.png>
...
tfr.head()
```
<img src=img/06-data-wrangling/long.png>
...
tfr_wide.head()
```
<img src=img/06-data-wrangling/wide.png>
...
tfr_long.head()
```
<img src=img/06-data-wrangling/long2.png>
